...
\scalebox{1}{
 \begin{tabular}{c c c c c}
    \small{} & \small{} &  \small{} &   \hspace{2cm} &\small{\begin{pspicture}(0.3cm,0.3cm) \psbarcode{123}{eclevel=L width=0.25 height=0.25}{qrcode}\end{pspicture}} \\
    \small{} & \small{} & \small{} & \small{} & \tiny{\color{black}\texttt{sax}}
  \end{tabular}
